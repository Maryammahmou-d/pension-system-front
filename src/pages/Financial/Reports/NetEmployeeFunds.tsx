...
import { lookupsApi, netEmployeeFundsApi } from '../../../lib/api';
import type { CompanySummary, EmployeeSummary, NetEmployeeFundsResult } from '../../../types';
          ...
          <>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginTop: 20 }}>
              ...
              <input
                ...
                type="text"
                readOnly
                value={`${result.employeeNumber} — ${result.employeeName} | ${result.valuationDate}`}
